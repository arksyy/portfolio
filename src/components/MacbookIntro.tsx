      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              width: "clamp(340px, 75vw, 960px)",
              height: "clamp(220px, 49vw, 620px)",
          ...
          >
            ...
            >
              <div className="w-full h-full rounded-t-xl bg-editor-bg overflow-hidden relative">
                {/* Notch */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100px] h-[16px] bg-[#111] rounded-b-xl z-20" />
                {/* Camera dot */}
    ...
    <div className="p-2">
      ...
      <div className="flex mt-1">
        ...
        <div className="flex-1 p-1">
          <div className="text-[5px] text-syntax-comment"># Alexandre Roy</div>
